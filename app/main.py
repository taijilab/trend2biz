...
<body>
  ...
  <!-- 10. YC 综合评分 -->
  <details{"" if not _is_v5 else " style='margin-bottom:16px'"}>
    {"" if not _is_v5 else "<summary style='cursor:pointer;font-size:12px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:.05em;padding:12px 0'>🎯 YC 综合评分（旧版，展开查看）</summary>"}
    <div class="card">
      {"" if _is_v5 else "<h2>🎯 YC 综合评分</h2>"}
      <div class="tbl-wrap"><table>
